package com.android.liujian.flichrphotos.view;
...
import com.android.liujian.flichrphotos.view.SlidingMenu.OnClosedListener;
import com.android.liujian.flichrphotos.view.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	float distanceInfluenceForSnapDuration(float f) {
		...
		f *= 0.3f * Math.PI / 2.0f;
		return (float) Math.sin(f);      //FloatMath.sin(f);
	}
